...
/*
 * \brief Add control dependencies among nodes that mutate shared entries.
 */
class OrderMutationPass : public Pass {
 public:
  PassResult RunOnGraph(Graph src, const PassArgument& ) override {
    PassResult ret;
    ...
    for (const NodeEntry &e : src.outputs) {
      ret.graph.outputs.emplace_back(NodeEntry{
